...
//		private Invoice invoice;
		...
		public String toString() {
			return "Booking [creationBookMoment=" + creationBookMoment
					+ ", arrivalDate=" + arrivalDate + ", numberOfNights="
					+ numberOfNights + ", numberOfBeds=" + numberOfBeds
					+ ", pricePerNight=" + pricePerNight + ", bookComments="
					+ bookComments + ", lodgeAssessment=" + lodgeAssessment
					+ ", pilgrim=" + pilgrim + ", lodge=" + lodge + "]";
		}
