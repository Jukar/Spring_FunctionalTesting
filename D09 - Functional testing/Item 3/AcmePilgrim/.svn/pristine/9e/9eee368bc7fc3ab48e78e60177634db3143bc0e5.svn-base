...
public class ComplaintService {
	...
	public Collection<Complaint> findOrderedByStatus() {
		checkPrincipal("ADMIN");
		Collection<Complaint> result=complaintRepository.findOrderedByStatus();
		return result;
	}
	...
	private void checkPrincipalSave(Complaint complaint) {
		...
		if(principal.equals(complaint.getReffered())){
			res=true;
		}
		Assert.isTrue(res);
	}
