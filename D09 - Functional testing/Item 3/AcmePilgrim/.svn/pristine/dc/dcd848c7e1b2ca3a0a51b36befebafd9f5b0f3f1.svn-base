...
public class LandmarkPilgrimController extends AbstractController{
	...
	public ModelAndView delete(@RequestParam int landmarkId){
		ModelAndView result;
		Landmark landmark=landmarkService.findOne(landmarkId);
		try{
	...
	protected ModelAndView createEditModelAndView(Landmark landmark, String message){
		...
		result.addObject("requestURI","landmark/pilgrim/edit.do");
