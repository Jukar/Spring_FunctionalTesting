...
<display:table name="stageRatings" id="row" requestURI="${requestURI}" pagesize="5" class="displaytag">
	...
	<display:column property="startMoment" title="${startMoment}" sortable="true" format="{0,date,dd/MM/yyyy  HH:mm}"></display:column>
	
	<spring:message code="stageRating.endMoment" var="endMoment"></spring:message>
	<display:column property="endMoment" title="${endMoment}" sortable="true" format="{0,date,dd/MM/yyyy  HH:mm}"></display:column>
