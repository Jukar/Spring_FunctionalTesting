...
//	private PilgrimService pilgrimService;
	...
	public ModelAndView listAllByPilgrim(){
		...
		anecdotes = anecdoteService.findByPilgrim();
	...
	public ModelAndView edit(@RequestParam int anecdoteId){
		...
		Anecdote anecdote = anecdoteService.findOne(anecdoteId);
	...
	public ModelAndView cancel(AnecdoteForm anecdoteForm, BindingResult binding){
		ModelAndView result;
		...
		try{
			...
			result = createEditModelAndView(anecdoteForm, "anecdote.edit.delete.error");
		}
		return result;
	}
...
//	}
	...
	private ModelAndView createEditModelAndView(AnecdoteForm anecdoteForm, String message){
		ModelAndView result;
		Collection<Route> routes = routeService.findByPilgrim();
